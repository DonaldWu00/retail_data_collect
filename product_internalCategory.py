...
def main_request():
    ...
    url = "https://open.nhanh.vn/api/product/internalcategory"
    ...
    for parent in parents:
        if parent.get("childs"):
            ...
            for child in childs:
                ...
                query_1 = f"INSERT INTO Product_internalCategory VALUES ({','.join(['?' for val in char])})"
                cursor.execute("DELETE Product_internalCategory WHERE id = '" + f'{id}' + "'")
